...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/weifenghelper/index.vue */ 21));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _index_vue_vue_type_template_id_65ec1a5b___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=65ec1a5b& */ 22);
...
var _default = { data: function data() {return { title: '基于企业微信的新一代CRM', service_btn: '点击接入在线客服', bgUrl: '/static/bg-img.png', logoUrl: '/static/logo.png', //获取用户openid的域名
    ...
    if (option.scene) {var weifengSessionId = decodeURIComponent(option.scene);if (weifengSessionId.slice(-1) === "1") {this.weifeng = weifengSessionId;} else {this.codeType = 2;this.weifeng = weifengSessionId + 'openId:';}}if (option.agent) {
      var agentId = option.agent;
